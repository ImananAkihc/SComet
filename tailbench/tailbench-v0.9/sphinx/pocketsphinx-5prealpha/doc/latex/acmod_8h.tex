...
This function moves to the next frame of input data. Subsequent calls to \doxyref{acmod\-\_\-score()}{p.}{acmod_8c_acd78e9bae06724df9c53f844d90c1c8a} will return scores for that frame, until the next call to \doxyref{acmod\-\_\-advance()}{p.}{acmod_8c_a338971ea0aa27fb4796d224e4767642b}.
...
Unlike \doxyref{acmod\-\_\-process\-\_\-raw()}{p.}{acmod_8c_a23e63c8833e6128ae248e183d42f9b2b} and \doxyref{acmod\-\_\-process\-\_\-cep()}{p.}{acmod_8c_a9464f7708a361171469d613d401619fe}, this function accepts a single frame at a time. This is because there is no need to do buffering when using dynamic features as input. However, if the dynamic feature buffer is full, this function will fail, so you should either always check the return value, or always pair a call to it with a call to \doxyref{acmod\-\_\-score()}{p.}{acmod_8c_acd78e9bae06724df9c53f844d90c1c8a}.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Array of senone scores for this frame, or N\-U\-L\-L if no frame is available for scoring (such as if a frame index is requested that is not yet or no longer available). The data pointed to persists only until the next call to \doxyref{acmod\-\_\-score()}{p.}{acmod_8c_acd78e9bae06724df9c53f844d90c1c8a} or \doxyref{acmod\-\_\-advance()}{p.}{acmod_8c_a338971ea0aa27fb4796d224e4767642b}. 
\end{DoxyReturn}
