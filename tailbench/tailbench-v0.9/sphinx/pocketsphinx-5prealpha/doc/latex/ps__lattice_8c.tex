...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Posterior probability for this link. Log is expressed in the log-\/base used in the decoder. To convert to linear floating-\/point, use logmath\-\_\-exp(\doxyref{ps\-\_\-lattice\-\_\-get\-\_\-logmath()}{p.}{ps__lattice_8h_a5c9d9171c9846c46c107bfe41a9120cf}, pprob). 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Posterior probability of the best link exiting this node. Log is expressed in the log-\/base used in the decoder. To convert to linear floating-\/point, use logmath\-\_\-exp(\doxyref{ps\-\_\-lattice\-\_\-get\-\_\-logmath()}{p.}{ps__lattice_8h_a5c9d9171c9846c46c107bfe41a9120cf}, pprob). 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em beam} & Minimum posterior probability for links. This is expressed in the log-\/base used in the decoder. To convert from linear floating-\/point, use logmath\-\_\-log(\doxyref{ps\-\_\-lattice\-\_\-get\-\_\-logmath()}{p.}{ps__lattice_8h_a5c9d9171c9846c46c107bfe41a9120cf}, prob). \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
